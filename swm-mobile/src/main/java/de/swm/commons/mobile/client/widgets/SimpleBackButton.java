 ...
 * 
 */
public class SimpleBackButton extends Button {

	/**
	 * Default constructor.
	 */
	public SimpleBackButton() {
		setHTML("Back");
	 ...
	 *            click handler
	 */
	public SimpleBackButton(String caption, ClickHandler handler) {
		setHTML(caption);
	 ...
	 */
	public SimpleBackButton(String caption, FastClickHelper.FastClickHandler handler) {
		setHTML(caption);
