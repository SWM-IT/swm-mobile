...
import de.swm.commons.mobile.client.widgets.date.DateCalculation;
...
public class SimpleDatePopup extends SimplePopup {
	 ...
	 */
	public SimpleDatePopup(Date givenDate, final DateStyle dateStyle, DateSelectionHandler handler) {
